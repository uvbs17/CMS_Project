...
<body>
	...
	<main role="main" class="col-xl-10 col-lg-12 col-md-12  ml-sm-auto px-md-4 mb-2 w-100">
		<section class=" mt-4">
			<h1 style="text-align: center;">Classes Time Table</h1>
			<?php
				...
				if((mysqli_num_rows($c_run)) > 0 )
				{
					...
					while ($row = mysqli_fetch_array($c_run))
					{
						if($i % 3 == 0 )
						{
							...
							<div onclick="window.location.href = '/CMS/dept_admin/course_time-table.php?course_code=<?= $row['course_code']; ?>';" class="card card1">
