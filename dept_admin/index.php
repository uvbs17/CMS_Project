...
if (isset($_POST["btnlogin"])) {
    ...
    $query = "SELECT * FROM admin_info WHERE user_id='$username' AND password='$password' ";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($username == $urname && $password == $pass) {
            $_SESSION['Logininfo'] = array('user_id' => $row['user_id'], 'password' => $row['password'], 'role' => 'dept',  'dep_id' => $row['dept_id']);
        ...
        <div class="content">
            ...
            <form action="index.php" method="post">
                <div class="field">
                    ...
                    <input type="text" name="email" value="admin123" placeholder="User ID" required>
                </div>
                <div class="field space">
                    <span class="fa fa-lock"></span>
                    <input type="Password" name="password" value="admin123" placeholder="Password" class="pass-key" required>
